...
<head>
	...
	<title>Artist Casting - <?php echo "$jobtitle"; ?></title>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($jobtype == "Director") { print ' selected '; } ?> value="Director" data-content="<span class='label label-warning'>Director</span>">Director</option>
															<option <?php if ($jobtype == "Cinematographer") { print ' selected '; } ?> value="Cinematographer" data-content="<span class='label label-danger'>Cinematographer</span>">Cinematographer</option>
															<option <?php if ($jobtype == "Acting") { print ' selected '; } ?> value="Acting" data-content="<span class='label label-success'>Acting</span>">Acting</option>
														</select>
													</div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Artist Casting</h5>
											<p>Artist Casting is a job portal, online job management system developed by Group 1.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Artist Casting Contact</h5>
