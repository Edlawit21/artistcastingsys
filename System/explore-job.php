...
try {
	...
	$compid = $row['company'];
	if ($jobtype == "Acting") {
	$sta = '<span class="label label-success">Acting</span>';
											  
	}
	if ($jobtype == "Cinematographer") {
	$sta = '<span class="label label-danger">Cinematographer</span>';
											  
	}
	if ($jobtype == "Director") {
	$sta = '<span class="label label-warning">Director</span>';
...
<head>
	...
	<title>Artist Casting Jobs - <?php echo "$jobtitle"; ?></title>
    ...
    <meta property="og:image:alt" content="Artist Casting" />
 ...
 function (str) {
  ...
  if (videoLink !== null) {
    var txt;
    var r = confirm("Are you sure you want to apply for this job? This action cannot be undone.");
    if (r == true) {
      ...
      xmlhttp.open("GET", "app/apply-job.php?opt=" + str + "&video_link=" + videoLink, true);
      xmlhttp.send();
    } else {
      // User canceled the confirmation
    }
  } else {
    // User canceled entering the video URL
  }
}
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="job-detail-wrapper">
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login as director or user to apply</button>';
								}	
								}
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Artist Casting  Jobs is a job portal for artists, developed by roup 1 for intenship project.</p>
