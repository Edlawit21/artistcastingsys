...
<head>
	...
	<title>Artist Casting Jobs - <?php echo "$title"; ?></title>
				...
				<div class="container">
					...
					<form action="job-list.php" method="GET" autocomplete="off">
						...
						<div class="second-search-result-inner">
							<span class="labeling">Search casts</span>
							<div class="row">
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
								...
								if ($type == "Acting") {
								$sta = '<span class="job-label label label-success">Acting</span>';
											  
								}
								if ($type == "Cinematographer") {
								$sta = '<span class="job-label label label-danger">Cinematographer</span>';
											  
								}
								if ($type == "Director") {
								$sta = '<span class="job-label label label-warning">Director</span>';
