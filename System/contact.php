...
<head>
	...
	<title>Artist Casting Jobs - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Ethiopia, <br/> PO.BOX 1234ABCD, <br/>KurazTech</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:assefaabenezer00@gmail.com">edlawitbeyene21@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+251966816600">+251966816600</a>
								</li>
