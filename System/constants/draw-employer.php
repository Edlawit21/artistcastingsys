...
<h4 class="modal-title text-center">Welcome My Producer</h4>
</div>
...
<input class="form-control" placeholder="Enter your first name" name="company" required type="text"> 
</div>
...
<input class="form-control" placeholder="Eg: Executive Producer, Co-Producer etc" name="type" required type="text"> 
</div>
