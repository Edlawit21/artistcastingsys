...
<head>
	...
	<title>Artist Casting Jobs - Job Portal</title>
    ...
    <meta property="og:image:alt" content="Artist Casting Jobs" />
...
<body class="home">
	...
	<div class="container-wrapper">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/logof.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employers.php">Producers</a>
							</li>
							
							<li>
								<a href="employees.php">Directors</a>
							</li>
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employer" class="btn btn-facebook btn-block mb-5-xs">Register as Producer</a>
						</div>
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as Director</a>
						</div>
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=User" class="btn btn-facebook btn-block mb-5-xs">Register as User</a>
						</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/images.jpeg');">
				<div class="container">

					<h1>Unleash Your Talent, Find Your Stage!</h1>
					<p>Connecting Artists to Opportunities. Find Your Casting Jobs Here.</p>
							...
							<div class="form-holder">
								<div class="row gap-0">
									...
									<div class="col-xss-6 col-xs-6 col-sm-6">
                                        ...
                                        $stmt = $conn->prepare("SELECT * FROM tbl_countries WHERE country_name IN ('Ethiopia', 'Eritrea') ORDER BY country_name");
$stmt->execute();
$result = $stmt->fetchAll();

foreach ($result as $row) {
    ?>
    <option value="<?php echo $row['country_name']; ?>" <?php if ($row['country_name'] == 'Ethiopia' || $row['country_name'] == 'Eritrea') { echo 'selected'; } ?> style="color: black;"><?php echo $row['country_name']; ?></option>
    <?php
						...
						<div class="row">
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5>01 / Search for jobs/casts</h5>
									</div>
			...
			<div class="pt-0 pb-50">
				...
				<div class="container">
					...
					<a target="_blank" href="company.php?ref=<?php echo $row['member_no']; ?>">View Producer</a>
					</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							$stmtb = $conn->prepare("SELECT * FROM tbl_users WHERE member_no = '$company_id' and role = 'employer' || 'employee'");
                            $stmtb->execute();
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Artist Casting  Jobs</h5>
											<p>Artist Casting  Jobs is a job portal for artists, developed by Group 1 for internship project.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="employers.php">Producers</a></li>
											<li><a href="employees.php">Directors</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Artist Casting Jobs Contact</h5>
								
								<p>Address :  Kuraz tech, PO.BOX ABCD1234</p>
								<p>Email : <a href="mailto:assefaabenezer00@gmail.com">edlawitbeyene21@gmail.com/a></p>
								<p>Phone : <a href="tel:+251966816600">+251963152638</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Artist Casting Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Group 1</a></li>
								</ul>
