...
<head>
	...
	<title>Artist Casting Jobs - Post Job</title>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option value="Director" data-content="<span class='label label-warning'>Director</span>">Director</option>
															<option value="Cinematographer" data-content="<span class='label label-danger'>Cinematographer</span>">Cinematographer</option>
															<option value="Acting" data-content="<span class='label label-success'>Acting</span>">Acting</option>
														</select>
													</div>
