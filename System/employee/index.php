...
<head>
	...
	<title>Artist Casting Jobs - Employee Profile</title>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2>Profile</h2>
										<h4 style="color: red;">Please fill all the reqired information to be able to be hired.</h4>
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-md-4">
														<input value="<?php echo "$mytitle"; ?>" name="title" required type="text" class="form-control mb-15" placeholder="Eg:  (BFA) in Theatre - Acting">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<select name="country" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           {
		                                                  ?>
					<option <?php if ($row['country_name'] == 'Ethiopia') { echo 'selected'; } ?> value="<?php echo $row['country_name']; ?>"><?php echo $row['country_name']; ?></option>
					<?php
