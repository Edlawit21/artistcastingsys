...
<head>
	...
	<title>Artist Casting Jobs - Applicants for the job <?php echo "$job_title"; ?></title>
					...
					<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
						    ...
						    foreach ($resultb as $rowb) {
						        ...
						        // Fetch the URL associated with the job application
						        $url = $row['url'];
									...
									<div class="employee-grid-item">
										...
										<a target="_blank" href="../employee-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix">
											...
											<div class="content">
												...
												<?php if (!empty($url)) { ?>
    <h6 class="text-primary">URL: <a href="<?php echo $url; ?>" target="_blank"><?php echo substr($url, 0, 30); ?></a></h6>
<?php } ?>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<h5 class="footer-title">About Artist Casting Jobs</h5>
											<p>Artist Casting Jobs is a job portal, online job management system Developed by Group 1 for internship project.</p>
